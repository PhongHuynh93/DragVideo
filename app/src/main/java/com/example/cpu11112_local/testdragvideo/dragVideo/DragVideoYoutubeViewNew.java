 ...
 */
public class DragVideoYoutubeViewNew extends ViewGroup {
    @BindView(R.id.videoView)
    View mVideoPlayer;
    @BindView(R.id.glVideo)
    Guideline mGlVideo;
    @BindView(R.id.glClose)
    Guideline mGlClose;
    @BindView(R.id.glPlay)
    Guideline mGlPlay;
    @BindView(R.id.tvTitle)
    TextView mTvTitle;
    @BindView(R.id.tvSubtitle)
    TextView mTvSubtitle;
    @BindView(R.id.imgvPlay)
    ImageView mImgvPlay;
...
//    private int mVerticalRange;
    ...
    // TODO: 10/18/2018 guideline of the mini MV
    public static final float GUIDELINE_MV = 0.42f;
    public static final float GUIDELINE_PLAY = 0.74f;
    public static final float GUIDELINE_CLOSE = 0.87f;

    public DragVideoYoutubeViewNew(Context context) {
        this(context, null);
    }

    public DragVideoYoutubeViewNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragVideoYoutubeViewNew(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!mIsFinishInit) {
            ...
            mRangeScrollY = (int) (this.getMeasuredHeight() - getPaddingTop() - getPaddingBottom() - MIN_RATIO_HEIGHT * mPlayerMaxHeight - marginBottom);
            mIsFinishInit = true;
        }
    }
    ...
    // hide this view, minimize the player so when show the video, it will grow bigger
...
//        mLeft = mHorizontalRange - mPlayerMinWidth;
        ...
        mIsMinimum = true;
        mVerticalOffset = 1f;
        mGlVideo.setGuidelinePercent(GUIDELINE_MV);
        mGlPlay.setGuidelinePercent(GUIDELINE_PLAY);
        mGlClose.setGuidelinePercent(GUIDELINE_CLOSE);
    }
